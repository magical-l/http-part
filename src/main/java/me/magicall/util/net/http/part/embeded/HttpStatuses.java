 ...
 */
public enum HttpStatuses implements HttpStatus {
    // 1xx Informational
    /**
     * {@code 100 Continue}.
     *
    ...
    HttpStatuses(final int statusCode, final String reasonPhrase) {
        code = statusCode;
        reason = reasonPhrase;
    }
    ...
    public static HttpStatuses valueOf(final int statusCode) {
        for (final HttpStatuses httpStatuses : values()) {
